...
def test_mc_course_attrs_courserule(caplog):
    ...
    by_course_rule = CourseRule(course='ECON 385', hidden=False, grade=None, grade_option=None, allow_claimed=False, path=tuple())
    by_course_clause = CourseRule(course='ECON 385', hidden=False, grade=None, grade_option=None, allow_claimed=False, path=tuple())
    by_attr = SingleClause(key='attributes', expected='econ_level_3', expected_verbatim='econ_level_3', operator=Operator.EqualTo)
...
def test_mc_spanish_sets(caplog):
    ...
    by_course = CourseRule(course='SPAN 313', hidden=False, grade=None, grade_option=None, allow_claimed=False, path=tuple())
